...
@Configuration
@MapperScan(value = "com.yztour.web.mapper", sqlSessionTemplateRef = "sqlSessionTemplate")
...
public class PersistentConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        factoryBean.setTypeAliasesPackage("com.yztour.web");
